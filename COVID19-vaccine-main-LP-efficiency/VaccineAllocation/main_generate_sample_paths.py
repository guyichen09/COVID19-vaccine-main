...
get_sample_paths(cook, vaccines, 0.85, 300,processor_rank=2323, timepoints=[117])
...
# export_rep_to_json(rep, "./output/cook/output_cook_more_var.json", "v0_a.json", "v1_a.json", "v2_a.json", "v3_a.json")
...
# plot_from_file("./output/cook/transmission_lsq_1.0_apr.json", "transmission_lsq_1.0_apr_raw.json", cook)
