...
def get_sample_paths(city,
    ...
    Realistic sample paths are exported as .json files so
    ...
    :param rsq_cutoff: [float] nonnegative number between [0,1]
    ...
    :param goal_num_good_reps: [int] positive integer
        ...
        to generate
    :param processor_rank: [int] nonnegative integer
...
def evaluate_policies_on_sample_paths(city,
    ...
    if rank == 0:
        print(min_num_policies_per_processor)
        start = time.time()
